...
SECRET_KEY = 'v1zjlckp=-&amp;r3@0%bg(qy7zyacs@7q8*w+ylw26r$ngi$#7!s7'
...
if DJANGO_CONF == "jenkins":
    DATABASE_ENGINE = 'django.db.backends.postgresql_psycopg2'
    DATABASE_NAME = 'aMuse'
    DATABASE_PASSWORD = 'jenkins'
...
try:
    ...
    print 'hey br0, you should configure ya own settingz'
